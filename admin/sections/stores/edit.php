...
<form method="post" action="#" enctype="multipart/form-data">
  ...
  <table>
    ...
    <tr>
      <th>*Address:</th>
      <td><input type="text" name="address" id="address_input" value="<?php echo $r['address'] ?>" /></td>
    </tr>
    <tr>
      <th>Address 2:</th>
    ...
    <tr>
      <th>*City/Town:</th>
      <td><input type="text" name="city" id="city_input" value="<?php echo $r['city'] ?>" /></td>
    </tr>
    <tr>
      <th>State/Province:</th>
      <td><input type="text" name="state" id="state_input" value="<?php echo $r['state'] ?>" /></td>
    </tr>
    <tr>
      <th>*Postal Code:</th>
      <td><input type="text" name="postal" id="postal_input" value="<?php echo $r['postal'] ?>" /></td>
    </tr>
    <tr>
      <th>Country:</th>
      <td><?php /*?><input type="text" name="country" id="country_input" value="<?php echo $r['country'] ?>" /><?php */?>
    ...
    <tr>
      <td>&nbsp;</td>
      <td><input type="hidden" name="lat" id="lat_input" value="<?php echo $r['lat']?>" />
        <input type="hidden" name="lng" id="lng_input" value="<?php echo $r['lng']?>" />
        <input type="submit" value="Save" class="btn" />
        <input type="button" value="Back" onclick="document.location='index.html'" class="btn" /></td>
    </tr>
  </table>
</form>
